...
- `torrent_spire_ai-v3.0.1+1-release.apk`
...
5. Optionally upload `torrent_spire_ai-v3.0.1+1-release.apk` to internal testing if you need a direct-install artifact.
...
3. Upload `torrent_spire_ai-v3.0.1+1-release.apk` if you want a direct Android install artifact attached to the release.
